...
(function () {
  ...
  function u(n, r) {
    ...
    if (n.src)
      ...
      self.FileReader &&
      (n instanceof self.Blob || n instanceof self.File)
    ) {
      var a;
    ...
    for (var r, i = 2, o = t.byteLength; i < o; ) {
      if (255 != n.getUint8(i))
        return (
          e &&
            console.log(
              "Not a valid marker at offset " + i + ", found: " + n.getUint8(i),
            ),
          !1
        );
  ...
  function g(t, n, r, i, o) {
    ...
    for (l = 0; l < u; l++)
      ((a = r + 12 * l + 2),
        !(s = i[t.getUint16(a, !o)]) &&
          e &&
          console.log("Unknown tag: " + t.getUint16(a, !o)),
        (c[s] = m(t, a, n, r, o)));
    return c;
  }
  ...
  function h(t, n) {
    if ("Exif" != p(t, n, 4))
      return (e && console.log("Not valid EXIF data! " + p(t, n, 4)), !1);
    var l,
      u,
      c,
      d,
