...
export class ParticleSystem {
  ...
  createBackgroundParticles() {
    ...
    this.backgroundParticles = new THREE.Points(
      particlesGeometry,
      particleMaterial,
    );
  ...
  createInnerDiskParticles() {
    ...
    innerDiskGeometry.setAttribute(
      "position",
      new THREE.BufferAttribute(innerDiskPosArray, 3),
    );
    innerDiskGeometry.setAttribute(
      "color",
      new THREE.BufferAttribute(innerDiskColorsArray, 3),
    );
    ...
    this.innerParticleDisk = new THREE.Points(
      innerDiskGeometry,
      innerDiskMaterial,
    );
  ...
  createDiskParticles() {
    ...
    diskGeometry.setAttribute(
      "color",
      new THREE.BufferAttribute(diskColorsArray, 3),
    );
  ...
  createOutermostDiskParticles() {
    ...
    const outermostDiskPosArray = new Float32Array(
      outermostDiskParticleCount * 3,
    );
    const outermostDiskColorsArray = new Float32Array(
      outermostDiskParticleCount * 3,
    );

    for (let i = 0; i < outermostDiskParticleCount * 3; i += 3) {
      const radius =
        outermostInnerRadius +
        Math.random() * (outermostOuterRadius - outermostInnerRadius);
      const angle = Math.random() * Math.PI * 2;
    ...
    outermostDiskGeometry.setAttribute(
      "position",
      new THREE.BufferAttribute(outermostDiskPosArray, 3),
    );
    outermostDiskGeometry.setAttribute(
      "color",
      new THREE.BufferAttribute(outermostDiskColorsArray, 3),
    );
    ...
    this.outermostParticleDisk = new THREE.Points(
      outermostDiskGeometry,
      outermostDiskMaterial,
    );
  ...
  animate() {
    ...
    if (this.outermostParticleDisk.material.uniforms) {
      this.outermostParticleDisk.material.uniforms.time.value =
